...
export default class PiTester {
  ...
  static run(source, screen) {
    ...
    console.log("pilang Tester Version 0.1");
    ...
    try {
      ...
      if (e instanceof PiException) {
        console.error(
          `\u001B[31mpilang Version 0.1:  Error: [PiException] \u001B[0m${e}`
        );
      } else if (e instanceof ParseError) {
        console.log(e);
        console.error(
          `\u001B[31mpilang Version 0.1: Syntax error: [ParseError] \u001B[0m${e}`
        );
      } else {
        console.log(e);
        console.error(
          `\u001B[31mpilang Version 0.1: Error: Something went wrong!: ${e.constructor.name}\u001B[0m`
        );
      }
    }
  }
